...
particularly strict limitation. This has the obvious impact, that our
...
to the blandness of Arduino's technology itself, it would most likely
...
\item As we see this research project rather that an engineering
  project, we wont devote time to documentation-writing.
\end{itemize}
...
\section{Defining a potentiometer}
...
needed for this calibration and the C-implementation of this is shown in
...
graph. We will discuss this further in our evaluation of
...
quite like the potentiometer example (see \Fref[plain]{sec:potentiometer
