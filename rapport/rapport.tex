...
greatest common divisor is calculated and used to calculate the timeout vale of
...
C-wrappers\footnote{???found where???}\fixme{fix footnote}. Thus, as with the
...
in detail in the Pololu 3pi User's Guide\fixme{reference}.
