...
\item[Queue:] When a value arrives, queue a request to the sensor.  We
  ...
  such, as described in section \ref{event queue}).
...
The following Haskell code defines the abstract Fladuino interface for
a simple digital pushbutton.  We have omitted the module imports for
brevity.
