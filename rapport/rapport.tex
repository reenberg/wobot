...
We would like to thank Geoffrey Mainland, the author of Flask
which were the offshoot to our project (\cite{flask08} and
\cite{flask06}). We thank him both for his work on Flask and for
providing us with a C-quasiquotation library. It greatly aided our
project.
...
\section{Credits and how to obtain Fladuino}

The work presented in this report is heavily based on the Flask
framework (\cite{flask08}, \cite{flask06} and the publicly available
code.  Furthermore, Geoffrey Mainland graciously made a
C-quasiquotation library available to us that greatly aided our
project.

The code for the Fladuino project is stored in Git at
\url{http://github.com/reenberg/wobot/tree/master}, and can be checked
out with the following command:

\begin{verbatim}
git clone git://github.com/reenberg/wobot.git
\end{verbatim}

The Fladuino code is in the \textit{fladuino} subdirectory.
