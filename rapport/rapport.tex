...
In the following section we will go through the existing Flask
system. It's design and how you write sensor-network programs in
it. After that we will look at what isn't already in Flask, that is
needed when programming robots, and we will talk about how we have
extended Flask to Fladuino.
