...
protocol that uses a SPI interface or a open UART/USB protocol which uses a
DFU (Device Firmware Update) interface. 
...
The DFU protocol description can be retrieved by contacting the Bluegiga support
team.
