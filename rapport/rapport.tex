...
(specifically for the Arduino-platform), but doing that also involves
writing code for that kind of input-output systems which doesn't
...
had to find a way of programming these systems ... 
