...
state they encapsulate is atomically manipulated. \fixme{eventually
  add something about the need for this} The details for this notion,
as well as details about its implementation, can be found in
\Fref{sec:dataflowevaluationstrategy} and
