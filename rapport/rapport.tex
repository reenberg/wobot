...
these values.  The notion of an atomic subgraph serves the purpose of
...
fundamentally unsolvable in software.  Optimisations can be done, of
...
event queue is empty.  Thus, they are a useful facility for specifying
