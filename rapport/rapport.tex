...
counter will then be reset to zero.  This does not in itself implement
the ``repeat''--portion of Accumulate--Repeat, but we have removed the
loss of information, and can thus trivially take whatever action
repeated firings of the output node would have resulted in.
