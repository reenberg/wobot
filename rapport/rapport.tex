...
\begin{abstract}
  ...
  language for programming embedded processors scare on resource,
  using a staged compilation-strategy like the one found in Flask
  \cite{flask08}, where code native to the hardware-platform is
  generated from a data flow graph, which is then compiled to
...
\section{EWMA dataflow graph in code}
