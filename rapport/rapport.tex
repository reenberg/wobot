...
Flask program takes the form of an acyclic data flow graph, which
represents how data from sensors etc. are processed and sent to other
nodes in the network. When you "`run"' a Flask program, it generates
code generated in another more low-level language for sensor
networks. Our framework Fladuino follows exactly the same concepts as
Flask though its generates C-code written specifically for our
