...
example).  \fixme{is the above too heavily inspired on section 1.1 in
  "`Functional Reactive Programming for Real-Time reactive systems"'
  (Zhanyong Wan PhD thesis)?}
...
providez facilities for expressing the structure and behavior of a
