...
PCINT0..7 pins will only trigger the PCI0 IHF, this function must then see
which of the enabled PCINT0..7 pins that has changed its value since last time, by
