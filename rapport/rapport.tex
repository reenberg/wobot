...
potentiometers.  A description of a device consists of instructions on
how to initialise such a device and a way of uniquely identifying a
device, so we can have a way of referring to the specific device.  If
the device is used in more than one place, the unique identifier is
also used to avoid adding the initialisation code twice.
