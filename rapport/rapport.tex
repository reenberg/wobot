...
Yet its simplicity comes at a cost.  The interrupt handlers for the
buttons carry out their logic themselves, potentially causing race
conditions if they are invoked during the processing of the main loop.
Said loop is problematic as well, as the timing is embedded within it.
