...
In this report we present our programming framework for embedded
...
Since the \mathtt{arduinoDiecimila} platform is fully compatible and has
exactley the same pin configuration as the \mathtt{arduinoDuemilanove} platform, it can
...
the same Atmega processor and thus has the same pin configuration. It hovever
