...
\fixme{something about why we've chosen Arduino}.

Because the Arduino has a relatively limited computation capacity, we
...
pins by the name they are known by to the Atmel microcontroller.  This
choice is not as obvious as it may appear: we do lose a non-nil amount
of expressive power by restricting ourselves to the interface provided
by Arduino, rather than permitting complete exploitation of the
capabilities of the microprocessor.  Yet for the following reasons, we
