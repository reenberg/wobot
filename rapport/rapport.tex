...
holds the processor occupied for a given time period. Timer 0 uses a
16 bit register and timer 1 and 2 uses 8 bit registers. This
effectively means that timer 0 can count bigger numbers than timer 1
and 2. The registers is incremented at the speed of the processor, in
this case 16MHz, divided by a prescale factor which can be either of
