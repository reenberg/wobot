...
\begin{table}[h!]
  ...
  \begin{tabular}{|c|c|c|}
    \hline
    Contact number & Signal name & Wire colour \\
    1 & VCC & Red \\
    2 & D- & White \\
    3 & D+ & Green \\
    3 & GND & Black \\
...
interface. The Arduino BT board is shipped with the iWRAP firmware version
2.2.0 as default 

\fixme{and blalblalbla}

\subsubsection{iWRAP commands}

\fixme{brief description of iWRAP commands}

\subsubsection{Firmaware update}

\fixme{show picture http://www.arduino.cc/playground/Learning/BTWT11Interface.}
\fixme{correct the wrongly pin 3 and pin 8 description on the picture.}
...
\subsection{Uploading new firmware to the WT11 chip}
